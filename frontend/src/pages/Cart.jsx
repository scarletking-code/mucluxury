...
const Cart = () => {
  ...
  const {products, cartItems, currency, updateQuantity, navigate} = React.useContext(ShopContext);
      ...
      <div className="flex justify-end my-20">
        <div className="w-full sm:w-[450px]">
          ...
          <div className="w-full text-end">
            <button onClick={()=> navigate('/place-order')} className="bg-black text-white px-8 py-3 text-sm active:bg-gray-700">PROCEED TO CHECKOUT</button>
          </div>
        </div>
      </div>
