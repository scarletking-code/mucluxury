...
const PlaceOrder = () => {
  ...
  return (
    ...
    <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
      ...
      <input className='border border-gray-300 rounded px-3.5 py-1.5 w-full' type="text" placeholder='Address' />
      <div className="flex gap-3">
      ...
      <input className='border border-gray-300 rounded px-3.5 py-1.5 w-full' type="number" placeholder='Phone Number' />
    </div>
    ...
    <div className="mt-8">
      ...
      <div className="mt-12">
        ...
        <div className="w-full text-end mt-8">
          <button onClick={()=>navigate('/orders')} className="bg-black text-white px-16 py-3 text-sm rounded-full">PLACE ORDER</button>
        </div>
